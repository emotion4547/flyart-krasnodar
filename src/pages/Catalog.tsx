...
const Catalog = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <SEO 
        title={currentCategory ? `Шары ${currentCategory.name}` : "Каталог воздушных шаров"}
        description={
          currentCategory
            ? `${currentCategory.name} — воздушные шары с доставкой в Красноярске. Гелиевые, фольгированные, композиции и наборы. Быстрая доставка от 2 часов.`
            : "Каталог воздушных шаров с доставкой в Красноярске. Гелиевые шары, фольгированные фигуры, композиции на любой праздник."
        }
        keywords={
          currentCategory
            ? `${currentCategory.name}, воздушные шары ${currentCategory.name}, шары Красноярск, кошарик`
            : "каталог шаров, воздушные шары Красноярск, гелиевые шары купить"
        }
