  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      <SEO 
        ...
        description="Политика конфиденциальности интернет-магазина Кошарик. Обработка персональных данных."
        noindex
      />
      <Header />
            ...
            <div className="max-w-4xl mx-auto">
              <div className="bg-card rounded-2xl p-8 md:p-12 shadow-soft prose prose-gray max-w-none">
                <p className="text-muted-foreground mb-8">
                  ...
                  действует в отношении всей информации, которую интернет-магазин Кошарик может 
                ...
                <ul className="list-disc pl-6 text-muted-foreground space-y-2 mb-6">
                  ...
                  <li>2.3. Настоящая Политика применяется только к сайту Кошарик. Сайт не контролирует и не несёт ответственности за сайты третьих лиц.</li>
