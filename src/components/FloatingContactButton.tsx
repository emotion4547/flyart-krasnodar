    ...
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3">
      ...
      >
        ...
        >
          ...
          <div className={`${iconButtonClass} bg-foreground text-background`}>
        ...
        >
          ...
          <div className={`${iconButtonClass} bg-[#25D366] text-white`}>
        ...
        >
          ...
          <div className={`${iconButtonClass} bg-[#26A5E4] text-white`}>
            <svg className="h-6 w-6" viewBox="0 0 24 24" fill="currentColor">
        ...
        {/* VK */}
        <a
          href="https://vk.com/flyart_krasnoyarsk"
          target="_blank"
          rel="noopener noreferrer"
          className="group flex items-center gap-3"
        >
          ...
          <div className={`${iconButtonClass} bg-[#0077FF] text-white`}>
            <svg className="h-6 w-6" viewBox="0 0 24 24" fill="currentColor">
